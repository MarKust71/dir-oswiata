...
import { updateInactivityTimeoutAction } from '@/app/actions/settings'
  ...
  return (
    <form action={action} className="flex flex-1 flex-col gap-3">
      <div className="flex flex-col gap-1.5">
        <Label htmlFor="inactivityTimeoutSeconds">
          Czas bezczynności do wylogowania (w sekundach)
        </Label>
        <Input
          id="inactivityTimeoutSeconds"
